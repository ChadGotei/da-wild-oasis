...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-12 lg:gap-24 text-lg items-center px-4 md:px-8 lg:px-16 py-8 lg:py-16">
      ...
      <div className="col-span-1 md:col-span-2 mb-6 md:mb-0">
        <Image
          ...
          placeholder="blur"
          quality={80}
          className="object-cover w-full h-72 md:h-auto rounded-lg"
        />
      </div>

      <div className="hidden relative col-span-1 md:col-span-2 aspect-square mb-6 md:mb-0 md:block">
        <Image
          src={img2}
          placeholder="blur"
      ...
      <div className="col-span-1 md:col-span-3 mb-6 md:mb-0">
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div>
            <Link
              href="/cabins"
              className="inline-block mt-4 bg-accent-500 px-8 py-4 text-primary-800 text-lg font-semibold hover:bg-accent-600 transition-all rounded"
            >
